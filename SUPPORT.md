...
Hello, thank you for using Registry AppPaths! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-registry-apppaths/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-registry-apppaths/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-registry-apppaths/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - Registry AppPaths version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-registry-apppaths/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-registry-apppaths/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Registry AppPaths:
...
<div align="center">
  Thank you for using Registry AppPaths!
  <br>
